  ...
  return (
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto container mx-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
        <div className="relative w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white/95 backdrop-blur-xl p-8 shadow-2xl transition-all duration-300 scale-100 border border-white/20">
          ...
          <button
            onClick={onClose}
            className="absolute right-4 top-4 z-10 p-2 rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-100/80 transition-all duration-200 group"
          >
